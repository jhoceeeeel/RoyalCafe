...
<head>
   ...
   <link rel="stylesheet" href="../menucss/admin_style.css">
...
<section class="add-products">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <select name="category" class="box" required>
         ...
         <option value="Milk tea's">Milk tea's</option>
         <option value="Frappes">Frappes</option>
         <option value="Iced Tea's">Iced Tea's</option>
      </select>
...
<!-- custom js file link  -->
<script src="../menujs/admin_script.js"></script>
