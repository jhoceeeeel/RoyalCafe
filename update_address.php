...
if(isset($_POST['submit'])){
   ...
   $address = $_POST['user'] .', '.$_POST['house'].', '.$_POST['street'].', '.$_POST['barangay'] .', '. $_POST['city'] .', '. $_POST['province'] .', '. $_POST['country'] .' - '. $_POST['pin_code'];
...
<section class="form-container">
   ...
   <form action="" method="post">
      <h3>Your Address</h3>
      <input type="text" class="box" placeholder="Reciever's Name" required maxlength="50" name="user">
